...
const tabs = [
  ...
  { name: 'Favorieten', href: '#', current: false },
]
const team = [
  {
    name: 'Leslie Alexander',
    handle: 'lesliealexander',
    email: 'leslie@onsbedrijf.nl',
    phone: '0600000000',
    href: '#',
    imageUrl:
              ...
              <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <DialogTitle className="text-base font-semibold leading-6 text-gray-900">Contacten</DialogTitle>
                    ...
                    <li key={person.handle}>
                      <div className="group relative flex items-center px-5 py-6">
                        ...
                        <Menu as="div" className="relative ml-2 inline-block flex-shrink-0 text-left">
                          <MenuButton className="group relative inline-flex h-8 w-8 items-center justify-center rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
